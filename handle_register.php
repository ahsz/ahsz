<?php   
	...
	If($_POST["submit"])
	{
		...
		Else
		{
			$res=mysqli_query($con,"INSERT INTO USER (NEPTUN, NAME, TYPE, PASSWORD, TEAM_ID, DATE_CRT, DATE_MOD, EMAIL, ROLE_ID) VALUES ('$neptun','$name',1,'$pass',null,sysdate(),null,$email,null)");
			If($res)
			{
